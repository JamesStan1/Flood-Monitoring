...
export default function AlertsPage() {
  ...
  const alerts = [
    ...
    {
      id: 2,
      location: "Macajalar Bay Area",
      level: 'high',
      message: "Water level rising rapidly - Prepare for possible evacuation",
      time: "45 minutes ago"
    },
    {
      id: 3,
      location: "Upper Puerto Area",
      level: 'moderate',
      message: "Water level at 1.8m - Monitor situation closely",
      time: "2 hours ago"
    },
    {
      id: 4,
      ...
      level: 'low',
      message: "Minor flooding reported - No immediate danger",
      time: "5 hours ago"
    }
  ];
